...
class M_konsumen extends CI_Model {
    ...
    public function generate_kode_konsumen_farrel()
    {
    ...
    public function getALLDataKonsumenFarrel()
    {
        return $this->db->get('konsumen')->result();
    }
    public function edit_farrels($id)
    {
        $this->db->select('*');
    ...
    public function update($kode_farrel, $data)
    {
        $this->db->where('kode_konsumen', $kode_farrel);
