...
<html lang="en">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form method="post"action="<?= base_url()?>transaksi_farrel/update">
                
                <div class="form-group">
                    <input type="text" name="kode_transaksi" value="<?= isset($transaksi['kode_transaksi']);?>"  class="form-control" readonly>
                ...
                <div class="form-group">
                    <input type="text" id="harga"class="form-control" value="<?= isset($transaksi['harga_paket']); ?>"placeholder="Harga Paket" >
                </div>

                <div class="form-group">
                    <input type="number" name="berat" id="berat" class="form-control" value="<?= isset($transaksi['berat']);?>" placeholder="Berat (KG)">
                </div>

                <div class="form-group">
                    <input type="number" name="grand_total" id="grand_total" class="form-control"  value="<?= isset($transaksi['grand_total']);?>" placeholder="Grand Total" readonly>
                </div>

                <div class="form-group">
                    <input type="text" name="tgl_masuk" value="<?= isset($tgl_masuk);?>" class="form-control" placeholder="Tanggal Masuk"  readonly>
                </div>
...
<script>
    ...
    $('#berat').keyup(function(){
        ...
        // harga : id di form harganya
        //untuk menampung value beratnya
    });
